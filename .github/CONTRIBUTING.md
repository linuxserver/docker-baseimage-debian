# Contributing to baseimage-debian
...
```bash
git clone https://github.com/linuxserver/docker-baseimage-debian.git
cd docker-baseimage-debian
docker build \
  --no-cache \
  --pull \
  -t linuxserver/baseimage-debian:latest .
```
